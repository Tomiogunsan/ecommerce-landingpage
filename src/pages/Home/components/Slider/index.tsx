...
const Slider = () => {
  ...
  return (
    <div className="lg:h-[calc(100vh-160px)] h-[calc(100vh-80px)] mt-20 lg:mt-40 overflow-hidden relative">
      <div
        ...
        {slides.map((slide) => (
          ...
          >
            <div className="h-1/2 xl:w-1/2 xl:h-full flex flex-col   items-center justify-center gap-8 2xl:gap-12 text-center ">
              <h2 className="text-xl lg:text-3xl 2xl:text-5xl pt-8 lg:pt-14">
                {slide.description}
              </h2>
      ...
      <div className="absolute m-auto left-1/2 -translate-x-1/2 bottom-6 flex gap-4">
